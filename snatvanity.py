...
# Updated by Snatcoin Developers snatcoinOfficial/snatcoin, february 2018, public domain
...
def test(otherversion):
    ...
    while foundit == 0:
          adsx = get_addr(gen_eckey(compressed=True,version=1),version=1)
          startofpub = adsx[0][:len(lookingfor)]
          countertries += 1

          if startofpub == lookingfor:
             print "Your Snatcoin public key:"
             print adsx[0]
             print "\n"
             print "Your Snatcoin private key:"
             print adsx[1]
             print "\n"
             print "YAY! Found your Snatcoin vanity address after", countertries, "tries"
             print "\n"
             foundit = 1
